...
public class Solution {
    public bool CanAttendMeetings(List<Interval> intervals) {
        ...
        // foreach(Interval interv in sorted){
        //     Console.WriteLine(interv.start);
        //     Console.WriteLine(interv.end);
        // }

        for(int i = 0; i < sorted.Count - 1; i++){
            Interval interv1 = sorted[i];
            Interval interv2 = sorted[i + 1];
            Console.WriteLine(interv1.start);
            Console.WriteLine(interv1.end);
